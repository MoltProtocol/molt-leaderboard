...
const PROTOCOLS: Protocol[] = [
  {
    ...
    steps: [
      ...
      { title: 'Security Audit', description: 'Third-party audit focusing on entropy source manipulation, front-running resistance, and callback reentrancy', status: 'upcoming' },
      { title: 'Testnet Deployment', description: 'Base Sepolia deployment with faucet, example contracts (lottery, NFT reveal, gaming), and integration docs', status: 'upcoming' },
      { title: 'Mainnet Launch', description: 'Production deployment on Base mainnet with TypeScript SDK, React hooks, and Foundry/Hardhat plugins', status: 'upcoming' },
    ],
  },
  {
    ...
    steps: [
      ...
      { title: 'Testnet Node Network', description: 'Recruit 10-20 CT node operators. Testnet staking with mock tokens. Real inference requests from demo dApps.', status: 'upcoming' },
      { title: 'DAO Governance', description: 'Governor contract for model whitelist votes, fee parameter changes, and treasury allocation. Snapshot for off-chain signaling.', status: 'upcoming' },
      { title: 'Model Plugin System', description: 'Standardized ModelAdapter interface. Community can propose new models via governance. Plugin registry with versioning.', status: 'upcoming' },
      { title: 'Mainnet Launch', description: 'Production deployment with node incentive program, documentation portal, and enterprise API tier', status: 'upcoming' },
    ],
  },
];
