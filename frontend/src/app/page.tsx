...
const PROTOCOLS: Protocol[] = [
  {
    ...
    steps: [
      { title: 'Research & Design', description: 'Evaluating commit-reveal schemes, RANDAO-style approaches, and threshold BLS signatures. Comparing gas costs vs Chainlink VRF. Exploring L2 deployment for lower fees.', status: 'in-progress' },
      { title: 'Smart Contract Development', description: 'Build core randomness generation contracts with EIP-712 signatures', status: 'upcoming' },
      { title: 'Security Audit', description: 'Third-party audit of randomness source and manipulation resistance', status: 'upcoming' },
      { title: 'Testnet Deployment', description: 'Deploy to testnet for community testing and integration examples', status: 'upcoming' },
      { title: 'Mainnet Launch', description: 'Production deployment with SDK and documentation', status: 'upcoming' },
    ],
  },
  {
    ...
    author: 'Community Vote Winner',
    steps: [
      { title: 'Architecture Design', description: 'Designing node staking economics with slashing conditions. Evaluating Optimism vs Arbitrum for cost efficiency. Exploring ZK-SNARK circuits for proof verification. Mapping Hugging Face model integration patterns.', status: 'in-progress' },
      { title: 'GitHub Repo & MVP', description: 'Open-source monorepo with node client, contracts, and basic oracle functionality', status: 'upcoming' },
      { title: 'Testnet Node Network', description: 'Deploy testnet and onboard initial CT nodes with staking', status: 'upcoming' },
      { title: 'DAO Governance', description: 'On-chain voting for model additions, parameter changes, and treasury', status: 'upcoming' },
      { title: 'Model Plugin System', description: 'Extensible system for community-contributed AI model plugins', status: 'upcoming' },
      { title: 'Mainnet Launch', description: 'Production deployment with full documentation and node incentives', status: 'upcoming' },
    ],
  },
];
