            ...
            <Table>
              <TableHeader>
                <TableRow className="hover:bg-transparent border-border">
                  ...
                  <TableHead className="w-24 text-right text-xs font-medium text-muted-foreground">Comments</TableHead>
                  <TableHead className="w-24 text-right text-xs font-medium text-muted-foreground">Likes</TableHead>
